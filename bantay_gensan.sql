...
--
-- Host: localhost    Database: bantay_gensan
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `view_role_privileges`
--

DROP TABLE IF EXISTS `view_role_privileges`;
/*!50001 DROP VIEW IF EXISTS `view_role_privileges`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_role_privileges` AS SELECT 
 1 AS `GRANTEE`,
 1 AS `TABLE_NAME`,
 1 AS `PRIVILEGE_TYPE`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Dumping events for database 'bantay_gensan'
--
...
--
-- Final view structure for view `view_role_privileges`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_role_privileges` AS select `information_schema`.`table_privileges`.`GRANTEE` AS `GRANTEE`,`information_schema`.`table_privileges`.`TABLE_NAME` AS `TABLE_NAME`,`information_schema`.`table_privileges`.`PRIVILEGE_TYPE` AS `PRIVILEGE_TYPE` from `information_schema`.`TABLE_PRIVILEGES` where (`information_schema`.`table_privileges`.`GRANTEE` in ('\'admin_role\'@\'%\'','\'city_staff_role\'@\'%\'','\'barangay_officer_role\'@\'%\'','\'reporter_role\'@\'%\'')) order by `information_schema`.`table_privileges`.`GRANTEE`,`information_schema`.`table_privileges`.`TABLE_NAME`,`information_schema`.`table_privileges`.`PRIVILEGE_TYPE` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_user_roles` AS select `u`.`User` AS `User`,`u`.`Host` AS `Host`,if((`u`.`account_locked` = 'Y'),'No','Yes') AS `can_login`,group_concat(`r`.`FROM_USER` separator ', ') AS `assigned_role` from (`mysql`.`user` `u` join `mysql`.`role_edges` `r` on((`u`.`User` = `r`.`TO_USER`))) group by `u`.`User`,`u`.`Host`,`u`.`account_locked` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-05-07 19:29:41
